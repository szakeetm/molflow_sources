...
public:
  ...
  DWORD GetHitsSize(int nbMoments);
  DWORD GetTexSwapSize(BOOL useColormap);
  DWORD GetTexRamSize(size_t nbMoments);
  DWORD GetTexSwapSizeForRatio(double ratio,BOOL useColor);
  DWORD GetTexRamSizeForRatio(double ratio,BOOL useMesh,BOOL countDir,size_t nbMoments);
