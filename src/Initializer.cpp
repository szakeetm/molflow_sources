...
int Initializer::initAutoGenerated(SimulationManager *simManager, const std::shared_ptr<SimulationModel> &model,
...
int
Initializer::loadFromGeneration(const std::shared_ptr<SimulationModel> &model, GlobalSimuState *globState, double ratio,
