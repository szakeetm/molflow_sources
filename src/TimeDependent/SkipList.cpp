...
// constructor
Skip_Node::Skip_Node (int k, const Skip_t& v, int level)
        :  key(k), value(v)
{
...
*/
Skip_Node* Skip_list::makeNode (int key, Skip_t val, int level) {
...
*/
void Skip_list::insert(int searchKey, Skip_t newValue) {
