...
namespace Settings {
    ...
    extern flowgpu::MolflowGPUSettings simParams;
    extern unsigned int kernelDimensions[2]; // blocks and threads per block
}
...
public:
    ...
    static int initFromFile(SimulationManager *simManager, const std::shared_ptr<MolflowSimulationModel>& model, GlobalSimuState *globState, const std::shared_ptr<flowgpu::Model> &gpu_model);
    ...
    static int initFromArgv(int argc, char **argv, SimulationManager *simManager,
