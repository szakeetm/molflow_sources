...
static const int appVersionId = 2807; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.8.7";
//---------------------------------------------------
#if defined(_DEBUG)
