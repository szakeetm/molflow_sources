...
static const int appVersionId = 2805; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.8.5";
//---------------------------------------------------
#if defined(_DEBUG)
