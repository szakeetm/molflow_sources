...
static const int appVersionId = 2905; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.9.5 with force counters";
//---------------------------------------------------
#if defined(_DEBUG)
