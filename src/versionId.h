...
static const int appVersionId = 2902; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.9.2";
//---------------------------------------------------
#if defined(_DEBUG)
