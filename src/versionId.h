...
static const int appVersionId = 2806; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.8.6 beta";
//---------------------------------------------------
#if defined(_DEBUG)
