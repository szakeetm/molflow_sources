...
static const int appVersionId = 2904; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.9.4 (beta)";
//---------------------------------------------------
#if defined(_DEBUG)
