...
static const int appVersionId = 2906; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.9.6 with force counters";
//---------------------------------------------------
#if defined(_DEBUG)
