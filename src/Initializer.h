...
public:
    ...
    static int initAutoGenerated(SimulationManager *simManager, const std::shared_ptr<SimulationModel> &model,
    ...
    static int
    loadFromGeneration(const std::shared_ptr<SimulationModel> &model, GlobalSimuState *globState, double ratio,
