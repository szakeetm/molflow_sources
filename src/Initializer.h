...
public:
    ...
    static void initFromFile(SimulationManager *simManager, std::shared_ptr<MolflowSimulationModel> model, GlobalSimuState *globState, MolflowUserSettings& userSettings);
    static void initAutoGenerated(SimulationManager *simManager, std::shared_ptr<MolflowSimulationModel> model,
                                 GlobalSimuState *globState, double ratio, int steps, double angle); //throws error
