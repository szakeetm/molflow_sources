...
#[[        set(embedded_file ${input}_embedded.c)
        set(c_var_name ${input}_ptx)
        add_custom_command(
                OUTPUT ${embedded_file}
                COMMAND ${BIN2C} -c --padd 0 --type char --name ${c_var_name} ${input} > ${embedded_file}
                DEPENDS ${input}
                COMMENT "compiling (and embedding ptx from) ${input}"
        )]]
    ENDFOREACH( )
